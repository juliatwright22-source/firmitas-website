...
- **Not yet done / worth verifying next session:** an actual live test submission through the deployed site to confirm the na2/generic fallback logic works end-to-end and a contact really appears in HubSpot — this was built and reasoned through carefully but not verified against a real submission in this session.
